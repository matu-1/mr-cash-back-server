...
let DeliveryService = class DeliveryService extends crud_service_1.CrudService {
    constructor(deliveryRepository, creditService) {
    ...
    create(dto) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield this.creditService.findById(dto.creditId, 'Credit Not found');
            return _super.create.call(this, dto);
        });
    }
    findByCredit(creditId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.creditService.findById(creditId, 'Credit not found');
