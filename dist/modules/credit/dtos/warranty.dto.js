...
class Warranty {
    static _OPENAPI_METADATA_FACTORY() {
        return { brand: { required: true, type: () => String }, status: { required: true, type: () => String }, description: { required: true, type: () => String, minLength: 10 }, categoryId: { required: true, type: () => String }, creditId: { required: true, type: () => String }, photosUrl: { required: true, type: () => [String] } };
    }
}
__decorate([
