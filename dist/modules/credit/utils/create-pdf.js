...
function createContractPdf(dto) {
    ...
    const { nit, acreedorNombre, acreedorCI, acreedorExpedicion, acreedorDireccion, acreedorNroCasa, deudorNombre, deudorCI, deudorExpedicion, deudorDireccion, monto, montoTotal, quantityFee, fistFeeDate, lastFeeDate, warrantyDescription, nroFacturaCompra, facturaCompra, creationDate, } = dto;
    const [creationDay, creationMonth, creationYear] = (0, date_fns_1.format)(creationDate, 'd,MMMM,yy', { locale: es_1.default }).split(',');
        ...
        content: [
            ...
            'El Deudor conociendo las actividades que realiza el Acreedor y encontrándose de acuerdo con las características de las mismas, a través del presente documento ha solicitado un préstamo a intereses, con la respectiva constitución de una garantía prendaria.',
            {
                text: [
                    ...
                    ' (',
                    {
                        text: (0, written_number_1.default)(monto, { lang: 'es' }),
            ...
            },
            {
                text: [
                    ...
                    ' (',
                    {
                        text: (0, written_number_1.default)(montoTotal, { lang: 'es' }),
                        decoration: 'underline',
                    },
