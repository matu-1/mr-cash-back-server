...
exports.uploadConctract = exports.createContractPdf = void 0;
...
function createContractPdf(dto) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { nit, acreedorNombre, acreedorCI, acreedorExpedicion, acreedorDireccion, acreedorNroCasa, deudorNombre, deudorCI, deudorExpedicion, deudorDireccion, amount, totalAmount, quantityFee, warrantyDescription, nroFacturaCompra, facturaCompra, creationDate, } = dto;
        const [creationDay, creationMonth, creationYear] = (0, date_fns_1.format)(creationDate, 'd,MMMM,yy', { locale: esLocale }).split(',');
        const fistFeeDate = (0, date_fns_1.format)(dto.fistFeeDate, 'dd/MM/yyyy');
        const lastFeeDate = (0, date_fns_1.format)(dto.lastFeeDate, 'dd/MM/yyyy');
...
const uploadConctract = (dto) => __awaiter(void 0, void 0, void 0, function* () {
    const file = yield createContractPdf(dto);
    const body = new FormData();
    body.append('file', file, { filename: 'pdf.pdf' });
    body.append('upload_preset', 'mnzfvfae');
    try {
        const data = yield axios_1.default.post('https://api.cloudinary.com/v1_1/dugc89lbj/image/upload', body, {
        ...
        throw new common_1.BadRequestException('Ups ocurrio un error al subir el archivo');
    }
});
exports.uploadConctract = uploadConctract;
