...
let CreditService = class CreditService extends crud_service_1.CrudService {
    ...
    findAllByRange(start, end) {
        const _super = Object.create(null, {
            findAllByRange: { get: () => super.findAllByRange }
        });
        return __awaiter(this, void 0, void 0, function* () {
            return _super.findAllByRange.call(this, start, end, ['customer'], ['g', 'customer.id', 'customer.tokenNotification']);
        });
    }
    ...
    changeStatus(id, dto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.creditRepository.manager.transaction((manager) => __awaiter(this, void 0, void 0, function* () {
                if (dto.status === credit_constant_1.CREDIT_STATUS.ACCEPTED) {
    ...
    getQualityIndicators() {
      ...
      `, [month, credit_constant_1.CREDIT_STATUS.APPROVED, credit_constant_1.CREDIT_STATUS.COMPLETED]);
      ...
      `, [month]);
        ...
        and c.status = ? or c.status = ?
      `, [month, credit_constant_1.CREDIT_STATUS.APPROVED, credit_constant_1.CREDIT_STATUS.COMPLETED]);
            const [averageAmount, activedCustomer, quantityCredit, registeredCustomer, originalAmount,] = yield Promise.all([
            ...
            return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, averageAmount[0]), activedCustomer[0]), quantityCredit[0]), registeredCustomer[0]), originalAmount[0]);
        });
    }
    getQualityIndicatorsAnnual() {
        return __awaiter(this, void 0, void 0, function* () {
      ...
      `, [year, credit_constant_1.CREDIT_STATUS.APPROVED, credit_constant_1.CREDIT_STATUS.COMPLETED]);
            const activedCustomerPromise = this.creditRepository.manager.query(`
