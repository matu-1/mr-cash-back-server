...
let CreditController = class CreditController extends crud_controller_1.CrudController {
    ...
    calculateCredit(amount) {
        return __awaiter(this, void 0, void 0, function* () {
            const dto = new create_credit_dto_1.CreateCreditDto();
    ...
    getQualityIndicators() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.creditService.getQualityIndicators();
            return new response_1.Response(result);
        });
    }
    getQualityIndicatorsAnnual() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.creditService.getQualityIndicatorsAnnual();
            return new response_1.Response(result);
        });
    }
    getTotalByStatus() {
...
__decorate([
    (0, common_1.Get)('calculate-credit/:amount'),
    openapi.ApiResponse({ status: 200, type: require("../../utils/response").Response }),
    __param(0, (0, common_1.Param)('amount')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], CreditController.prototype, "calculateCredit", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Get quality Indicators',
    }),
    (0, common_1.Get)('quality-indicators'),
    openapi.ApiResponse({ status: 200, type: require("../../utils/response").Response }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CreditController.prototype, "getQualityIndicators", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Get quality Indicators',
    }),
    (0, common_1.Get)('quality-indicators-annual'),
    openapi.ApiResponse({ status: 200, type: require("../../utils/response").Response }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CreditController.prototype, "getQualityIndicatorsAnnual", null);
__decorate([
    (0, swagger_1.ApiOperation)({
