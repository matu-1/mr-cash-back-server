...
let CreditRepository = class CreditRepository extends typeorm_1.Repository {
};
CreditRepository = __decorate([
    (0, typeorm_1.EntityRepository)(credit_entity_1.Credit)
], CreditRepository);
