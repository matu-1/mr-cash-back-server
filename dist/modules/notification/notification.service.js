...
let NotificationService = class NotificationService extends crud_service_1.CrudService {
    constructor(notificationRepository, customerService, configService) {
    ...
    countNotificationUnseen(customerId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.notificationRepository.manager.query(`SELECT count(*) count FROM notification WHERE customer_id = "${customerId}" AND notification.read = 0`);
            return result[0];
        });
    }
    sendNotification(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!data.success)
                throw new common_1.BadRequestException(data.results[0].error);
            return data;
        });
    }
};
