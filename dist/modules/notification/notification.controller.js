...
let NotificationController = class NotificationController extends crud_controller_1.CrudController {
    ...
    countNotificationUnseen(customerId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.notificationService.countNotificationUnseen(customerId);
            return new response_1.Response(result);
        });
    }
    sendNotification(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.notificationService.sendNotification(dto);
            return new response_1.Response(result);
        });
    }
};
...
__decorate([
    (0, common_1.Get)('count/:customerId'),
    openapi.ApiResponse({ status: 200, type: require("../../utils/response").Response }),
    __param(0, (0, common_1.Param)('customerId', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], NotificationController.prototype, "countNotificationUnseen", null);
__decorate([
    (0, common_1.Post)('send-notification'),
    openapi.ApiResponse({ status: 201, type: require("../../utils/response").Response }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [send_notification_dto_1.SendNotification]),
    __metadata("design:returntype", Promise)
