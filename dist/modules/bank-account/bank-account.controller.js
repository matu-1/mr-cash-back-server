...
let BankAccountController = class BankAccountController extends crud_controller_1.CrudController {
    ...
    findByCustomer(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.bankAccountService.findByCustomer(id);
            return new response_1.Response(result);
        });
    }
    create(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.bankAccountService.create(dto);
            return new response_1.Response(result);
        });
    }
    update(id, dto) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.bankAccountService.update(id, dto);
            return new response_1.Response(result);
        });
    }
};
