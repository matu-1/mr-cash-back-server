...
__decorate([
    (0, typeorm_1.Column)({ type: 'tinyint', default: config_1.CONFIG.STATUS.ENABLED }),
...
__decorate([
    (0, typeorm_1.Column)({ length: 300, name: 'profile_photo_url', nullable: true }),
    __metadata("design:type", String)
], Customer.prototype, "profilePhotoUrl", void 0);
__decorate([
    (0, typeorm_1.Column)({ length: 300, name: 'identity_front_url', nullable: true }),
    __metadata("design:type", String)
], Customer.prototype, "identityFrontUrl", void 0);
__decorate([
    (0, typeorm_1.Column)({ length: 300, name: 'identity_back_url', nullable: true }),
    __metadata("design:type", String)
], Customer.prototype, "identityBackUrl", void 0);
__decorate([
    (0, typeorm_1.Column)({ length: 250, name: 'token_notification', nullable: true }),
    __metadata("design:type", String)
