...
class CreateCustomerDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, minLength: 3 }, phone: { required: true, type: () => String, minLength: 8 }, email: { required: true, type: () => String }, birthday: { required: true, type: () => String }, status: { required: true, type: () => Number }, referredCode: { required: true, type: () => String }, profilePhotoUrl: { required: false, type: () => String }, identityFrontUrl: { required: false, type: () => String }, identityBackUrl: { required: false, type: () => String }, tokenNotification: { required: false, type: () => String }, cityId: { required: true, type: () => String } };
    }
}
__decorate([
