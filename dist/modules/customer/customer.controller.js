...
let CustomerController = class CustomerController extends crud_controller_1.CrudController {
    ...
    create(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.customerService.create(dto);
            return new response_1.Response(result);
        });
    }
    update(id, dto) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.customerService.update(id, dto);
            return new response_1.Response(result);
        });
    }
    findByEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.customerService.findByEmail(email);
            return new response_1.Response(result);
        });
    }
    findByPhone(phone) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.customerService.findByPhone(phone);
            return new response_1.Response(result);
        });
    }
};
