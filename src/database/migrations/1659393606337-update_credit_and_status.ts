...
export class updateCreditAndStatus1659393606337 implements MigrationInterface {
    name = 'updateCreditAndStatus1659393606337'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`credit\` ADD \`percentage_storage\` double NOT NULL DEFAULT '3'`);
        await queryRunner.query(`ALTER TABLE \`credit_status\` ADD \`reason\` text NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`credit_status\` CHANGE \`user_id\` \`user_id\` varchar(255) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`credit_fee\` CHANGE \`coupon_id\` \`coupon_id\` varchar(255) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`credit_fee\` CHANGE \`photo_url\` \`photo_url\` varchar(255) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`credit_fee\` ADD CONSTRAINT \`FK_b9754b217840d1f379a809ef6b6\` FOREIGN KEY (\`coupon_id\`) REFERENCES \`coupon\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`coupon\` CHANGE \`description\` \`description\` text COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`coupon\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`credit\` CHANGE \`credit_previous_id\` \`credit_previous_id\` varchar(255) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`credit\` CHANGE \`disbursement_photo_url\` \`disbursement_photo_url\` varchar(255) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`credit\` CHANGE \`approved_photo_url\` \`approved_photo_url\` varchar(255) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`credit\` CHANGE \`disburse_at\` \`disburse_at\` datetime NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`credit\` CHANGE \`url_signature\` \`url_signature\` varchar(255) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`credit\` CHANGE \`url_contract\` \`url_contract\` varchar(255) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`warranty\` CHANGE \`description\` \`description\` text COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`category\` CHANGE \`description\` \`description\` text COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`token_notification\` \`token_notification\` varchar(250) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`identity_back_url\` \`identity_back_url\` varchar(300) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`identity_front_url\` \`identity_front_url\` varchar(300) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`profile_photo_url\` \`profile_photo_url\` varchar(300) COLLATE "utf8_spanish_ci" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`credit_status\` DROP COLUMN \`reason\``);
        await queryRunner.query(`ALTER TABLE \`credit\` DROP COLUMN \`percentage_storage\``);
    }
