...
export class credit1657593675587 implements MigrationInterface {
    name = 'credit1657593675587'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`bank_account\` ADD \`extension\` varchar(2) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`bank_account\` ADD \`address\` varchar(150) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`coupon\` CHANGE \`status\` \`status\` tinyint NOT NULL DEFAULT '1'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`credit_fee\` ADD CONSTRAINT \`FK_b9754b217840d1f379a809ef6b6\` FOREIGN KEY (\`coupon_id\`) REFERENCES \`coupon\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`coupon\` CHANGE \`status\` \`status\` tinyint NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE \`bank_account\` DROP COLUMN \`address\``);
        await queryRunner.query(`ALTER TABLE \`bank_account\` DROP COLUMN \`extension\``);
    }
