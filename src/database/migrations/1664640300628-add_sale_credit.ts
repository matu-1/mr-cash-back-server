...
export class addSaleCredit1664640300628 implements MigrationInterface {
    name = 'addSaleCredit1664640300628'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_c2a0383b114693e4622f4f11f0\` ON \`delivery\``);
        await queryRunner.query(`ALTER TABLE \`credit\` ADD \`sale_id\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`credit\` DROP COLUMN \`sale_id\``);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_c2a0383b114693e4622f4f11f0\` ON \`delivery\` (\`sale_id\`)`);
    }
