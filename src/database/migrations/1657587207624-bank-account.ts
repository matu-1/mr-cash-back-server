...
export class bankAccount1657587207624 implements MigrationInterface {
    name = 'bankAccount1657587207624'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`credit\` ADD \`numberId\` int NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`credit\` DROP COLUMN \`numberId\``);
    }
