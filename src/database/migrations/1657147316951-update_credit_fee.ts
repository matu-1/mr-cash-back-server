...
export class updateCreditFee1657147316951 implements MigrationInterface {
    name = 'updateCreditFee1657147316951'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`credit\` ADD \`disburse_at\` datetime NULL`);
        await queryRunner.query(`ALTER TABLE \`credit\` ADD \`express_disbursement\` tinyint NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`credit_fee\` ADD \`photo_url\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`credit_fee\` DROP COLUMN \`photo_url\``);
        await queryRunner.query(`ALTER TABLE \`credit\` DROP COLUMN \`express_disbursement\``);
        await queryRunner.query(`ALTER TABLE \`credit\` DROP COLUMN \`disburse_at\``);
    }
