...
export class updateCustomer1656544174008 implements MigrationInterface {
    name = 'updateCustomer1656544174008'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`phone\` varchar(11) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`status\` \`status\` varchar(40) NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`identity_back_url\` \`identity_back_url\` varchar(300) NOT NULL DEFAULT ''''`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`identity_front_url\` \`identity_front_url\` varchar(300) NOT NULL DEFAULT ''''`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`profile_photo_url\` \`profile_photo_url\` varchar(300) NOT NULL DEFAULT ''''`);
