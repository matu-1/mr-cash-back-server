...
export class updateCustomerStatus1656544844326 implements MigrationInterface {
    name = 'updateCustomerStatus1656544844326'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_32ca4bcf9c4b751dca420dd58fd\` ON \`credit\``);
        await queryRunner.query(`DROP INDEX \`FK_b9754b217840d1f379a809ef6b6\` ON \`credit_fee\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`status\``);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`status\` varchar(40) NOT NULL DEFAULT ''0''`);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`phone\``);
        ...
        await queryRunner.query(`CREATE INDEX \`FK_b9754b217840d1f379a809ef6b6\` ON \`credit_fee\` (\`coupon_id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_32ca4bcf9c4b751dca420dd58fd\` ON \`credit\` (\`credit_previous_id\`)`);
    }
