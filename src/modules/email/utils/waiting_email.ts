...
export const waitingTemplate = (dto: EmailDto) => {
  let template = `
                              ...
                              <tr>
                                <td align="center" style="padding-top: 16px">
                                  <p
                                    ...
                                    "
                                  >
                                    ¡Hola ${dto.name}! Gracias por estar de
                                    acuerdo con nuestros t&eacute;rminos y
                                    condiciones. Nuestro personal pasar&aacute;
                                    por la garant&iacute;a para verificar el
                                    estado de la misma.
                                  </p>
                                </td>
                              </tr>
