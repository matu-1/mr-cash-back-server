...
export const disbursementTemplate = (dto: EmailDto) => {
   let template =`
                               ...
                               <tr>
                                 <td align="center" style="padding-top: 16px">
                                   <p
                                     ...
                                     "
                                   >
                                     ¡Hola ${dto.name}! Ya hemos desembolsado el
                                     dinero a tu cuenta registrada. No olvides
                                     cancelar tus cuotas a tiempo para evitar
                                     multas e intereses extras.
                                   </p>
                                 </td>
                               </tr>
                             </tbody>
